...
<main class="bakery-container">
  ...
  <section class="feature-grid">
    <?=$infoObject->social('Website', '<article class="feature-card">
    ...
    <?=$infoObject->social('Booking', '<article class="feature-card">
  ...
  <section class="feature-grid">
  <?=$infoObject->social('OrderOnline', '<article class="feature-card">
    ...
    <?=$infoObject->address('<article class="feature-card">
  ...
  <section class="contact-section">
    ...
    <?=$infoObject->social('Facebook', '<img src="https://cdn.builder.io/api/v1/image/assets/TEMP/a33b95b1e96e864346811c9177fb38c1250e1daf363a1907428cc211f3962407?apiKey=076e1b6fb9564c54879ab1846aa9f941&" alt="" class="social-icon" />')['a'];?>
    <?=$infoObject->social('Instagram', '<img src="https://cdn.builder.io/api/v1/image/assets/TEMP/f115cc012d6f8f529c900770e080cfa35f379169a550de2cbeb5cd303f0dedb8?apiKey=076e1b6fb9564c54879ab1846aa9f941&" alt="" class="social-icon" />')['a'];?>
    <?=$infoObject->social('Youtube', '<img src="https://cdn.builder.io/api/v1/image/assets/TEMP/89fdf680a6c918497445f6e47f7d4321aed48a35f28f1139214354ad6714e8d9?apiKey=076e1b6fb9564c54879ab1846aa9f941&" alt="" class="social-icon" />')['a'];?>
    <?=$infoObject->social('Tiktok', '<img src="https://cdn.builder.io/api/v1/image/assets/TEMP/ec5c2c71e61bf3198f4f60c09fba45be81756eaaec96ad02d1e32847414f53c1?apiKey=076e1b6fb9564c54879ab1846aa9f941&" alt="" class="social-icon" />')['a'];?>
    </nav>
  </section>
