...
?> <!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><link rel="stylesheet" type="text/css" href="/controllers/default/css/universal.css?v=<?= $g['v']; ?>"><link rel="stylesheet" type="text/css" href="/controllers/default/css/user.css?v=<?= $g['v']; ?>"><title><?= $g['userTitle']; ?></title><script src="https://kit.fontawesome.com/960d33c629.js" crossorigin="anonymous"></script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script><style>#des::-webkit-scrollbar {
            display: none;
        }</style><script src="/dist/userjs8240d55fb4b4641ccd68.js"></script></head><body><div id="container"><div class="adminSection"><div class="info"><div class="info__img"><div class="info__img--location"><img src="<?= $image; ?> " alt="bio_user_avatar" draggable="false" style="width: 100%; height: 100%;"></div></div><div class="info__about"><div class="info__name"><div><h1><?= $infoArray['name']->getHTML(); ?></h1></div></div><div class="info__org"><div><h2><?= $infoArray['organization']->getHTML(); ?></h2></div></div><div class="info__des"><div><textarea id="des" rows="5" cols="15" style="border: none; resize: none; outline: none; font-size: 18px; text-align: center; scrollbar-width: none; -ms-overflow-style: none;"><?= $infoArray['description']->getHTML(); ?></textarea></div></div></div></div><div id="social-media"> <?php
