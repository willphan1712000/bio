...
?> <!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><link rel="stylesheet" type="text/css" href="/controllers/default/css/universal.css?v=<?= $g['v']; ?>"><link rel="stylesheet" type="text/css" href="/controllers/default/css/user.css?v=<?= $g['v']; ?>"><title><?= $g['userTitle']; ?></title><script src="https://kit.fontawesome.com/960d33c629.js" crossorigin="anonymous"></script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script><script src="/dist/userjs202e3cfbf6abbd8a222e.js"></script></head><body><div id="container"><div class="adminSection"><div class="info"><div class="info__img"><div class="info__img--location"><img src="<?= $image; ?> " alt="bio_user_avatar" draggable="false" style="width: 100%; height: 100%;"></div></div><div class="info__about"><div class="info__name"><div><h1><?= $infoArray['name']->getHTML(); ?></h1></div></div><div class="info__org"><h3 style="display: <?= $infoArray['organization']->getValue() === NULL ? 'none' : 'flex'; ?>">Position</h3><div><h2><?= $infoArray['organization']->getHTML(); ?></h2></div></div><div class="info__des"><div><h3><?= $infoArray['description']->getHTML(); ?></h3></div></div></div></div><div id="social-media"> <?php
