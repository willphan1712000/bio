...
?> <!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title><?= $g['adminTitle']; ?></title><script src="https://kit.fontawesome.com/960d33c629.js" crossorigin="anonymous"></script><script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script><script src="/dist/tailwindf29e58579e34943a7f7b.js"></script><script src="/dist/universalcc2d7b7cdae5892eb9f2.js"></script><script src="/dist/admin2a65ac18580388d066ff.js"></script><script src="/dist/adminjse890b3ea502f3d8f82bd.js"></script></head><body><div id="admin"><div id="notSupported"><p>Bio does not support wide screen!</p></div><div id="uploadImagePopup"></div><a href="/<?= $username; ?>" class="z-10 p-[15px] bg-white rounded-full w-[50px] h-[50px] flex justify-center items-center no-underline text-black cursor-pointer fixed top-[0.5rem] left-[0.5rem]" style="box-shadow: rgba(50, 50, 93, 0.25) 0px 6px 12px -2px,
        rgba(0, 0, 0, 0.3) 0px 3px 7px -3px;"><i class="fa-solid fa-arrow-left"></i></a><div class="z-10 rounded-[20px] cursor-pointer p-[15px] bg-white fixed top-[0.5rem] right-[0.5rem]" style="box-shadow: rgba(50, 50, 93, 0.25) 0px 6px 12px -2px,
