...
.backdrop-child > h1 {
  ...
  color: #fea3a3;
  font-size: 1.5rem;
}</style><main class="bakery-container"><div class="backdrop"><img src="<?=$props['imgPath'];?>" alt="Bakery storefront" class="hero-image"><div class="backdrop-child"><h1><?=$infoObject->name()['a'];?></h1><p class="tagline"><?=$infoObject->organization()['a'];?></p><p class="tagline"><?=$infoObject->description()['a'];?></p></div></div><section class="feature-grid"> <?=$infoObject->social('Website', '<article class="feature-card">
