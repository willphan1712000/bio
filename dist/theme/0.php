...
.social__img i {
  font-size: 20px;
}</style><div class="adminSection"><div id="template-container"><div class="info"><div class="info__img"><div class="info__img--location"><img src="<?=$props['imgPath'];?> " alt="" draggable="false"></div></div><div class="info__about"><div class="info__name"><div><h1><?=$infoObject->name()['a'];?></h1></div></div><div class="info__org"><div><h2><?=$infoObject->organization()['a'];?></h2></div></div><div class="info__des"><div><h3><?=$infoObject->description()['a'];?></h3></div></div></div></div><div id="social-media"> <?php
