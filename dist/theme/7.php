...
?> <div id="template-container" style="width:100%;"><style>.beauty-section {
  border-radius: 20px;
...
#social-media {
  margin: 10px 0px 10px 0px;
}</style><section class="beauty-section"><header class="hero-banner"><div class="avatar-wrapper"><img draggable="false" src="<?=$props['imgPath']."?v=".time();?> " alt="" class="avatar-img"></div><img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/dea77032a51d516ad82d4f4cfed164a9c9523bf104fffca6e4ef09b29db5de62?apiKey=076e1b6fb9564c54879ab1846aa9f941&" class="hero-image" alt="Beauty product showcase"><div class="title-wrapper"><h1 class="hero-title"><?=$infoObject->name()['a'];?></h1><p class="hero-description"> <?=$infoObject->organization()['a'];?> </p><p class="hero-description"> <?=$infoObject->description()['a'];?> </p></div></header><div class="feature-icons"> <?=$infoObject->social('Facebook', '<img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/9f998daf1a5914f376fea12e07efbe55395c8bf1943ceeb08dd2b7307234ff11?apiKey=076e1b6fb9564c54879ab1846aa9f941&" class="feature-icon" alt="Beauty feature 1" />')['a'];?> <?=$infoObject->social('Instagram', '<img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/89608fb58786d9ccf68551e93e5ba393ff8851fb9b84d7fab554366c8494af3c?apiKey=076e1b6fb9564c54879ab1846aa9f941&" class="feature-icon" alt="Beauty feature 2" />')['a'];?> <?=$infoObject->social('Youtube', '<img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/343cc0e154d9e7ed6e679f4ec926be79845cce0c03be37660c2ac01d5bb1f116?apiKey=076e1b6fb9564c54879ab1846aa9f941&" class="feature-icon" alt="Beauty feature 3" />')['a'];?> <?=$infoObject->social('Tiktok', '<img loading="lazy" src="https://cdn.builder.io/api/v1/image/assets/TEMP/7bd9c75c409cc7f69c0cfc2f5e1edcf38b0405e99d61cafe95b747f0fbb2c7ac?apiKey=076e1b6fb9564c54879ab1846aa9f941&" class="feature-icon" alt="Beauty feature 4" />')['a'];?> </div><div id="social-media"> <?php
    ...
    ?> </div></section></div><div id="userFooter"> <?php
