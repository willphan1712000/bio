...
?> <div id="template-container" style="width:100%;"><style>.div {
    border-radius: 20px;
  ...
  .div-21 {
    ...
    justify-content: center;
    padding: 18px 60px;
  }</style><div class="div"><div class="div-2"><div class="div-3"><img loading="lazy" src="<?=$props['imgPath']."?v=".time();?>" class="img"></div><div class="div-4"><?=$infoObject->name()['a'];?></div><div class="div-5"> <?=$infoObject->organization()['a'];?> <br> <?=$infoObject->description()['a'];?> </div> <?= $infoObject->mobile('<div class="div-6">Contact us</div>')['a'];?> <div class="div-7"> <?= $infoObject->social('Website', '<div class="div-8">
        <img
          loading="lazy"
      ...
      </div>')['a'];?> <?= $infoObject->social('Facebook', '<div class="div-10">
        <img
          loading="lazy"
      ...
      </div>')['a'];?> <?= $infoObject->social('Instagram', '<div class="div-12">
        <img
          loading="lazy"
      ...
      </div>')['a'];?> <?= $infoObject->social('Youtube', '<div class="div-14">
        <img
          loading="lazy"
      ...
      </div>')['a'];?> <?= $infoObject->social('Tiktok', '<div class="div-16">
        <img
          loading="lazy"
