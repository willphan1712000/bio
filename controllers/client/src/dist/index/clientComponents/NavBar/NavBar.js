...
const NavBar = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: 'border-[1px] border-black', children: [(0, jsx_runtime_1.jsxs)("div", { className: "w-full hidden lg:flex flex-row justify-between p-[10px] bg-white", children: [(0, jsx_runtime_1.jsx)("div", { className: "max-w-[250px] w-[40%]", children: (0, jsx_runtime_1.jsx)(Logo_1.default, {}) }), (0, jsx_runtime_1.jsx)("div", { className: "flex flex-row gap-5 justify-start items-center flex-1 px-10", children: (0, jsx_runtime_1.jsx)(Link_1.default, {}) }), (0, jsx_runtime_1.jsx)("div", { className: "flex flex-row gap-2 items-center", children: (0, jsx_runtime_1.jsx)(Button_1.default, {}) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col relative", children: [(0, jsx_runtime_1.jsxs)("div", { className: "w-full lg:hidden flex flex-row justify-between p-[10px] bg-white", children: [(0, jsx_runtime_1.jsx)("div", { className: "max-w-[250px] w-[40%]", children: (0, jsx_runtime_1.jsx)(Logo_1.default, {}) }), (0, jsx_runtime_1.jsx)("div", { className: "flex flex-col items-start justify-center text-[30px] cursor-pointer transition-all", id: "navBtn", children: (0, jsx_runtime_1.jsx)("i", { className: "fa-solid fa-bars" }) }), (0, jsx_runtime_1.jsx)("div", { className: "flex-col items-start justify-center text-[30px] cursor-pointer transition-all hidden", id: "navBtnClose", children: (0, jsx_runtime_1.jsx)("i", { className: "fa-solid fa-circle-xmark" }) })] }), (0, jsx_runtime_1.jsxs)("div", { className: "bg-white p-5 rounded-[30px] absolute top-[110%] left-0 w-full z-[99] invisible", id: "nav", children: [(0, jsx_runtime_1.jsx)("div", { className: "flex flex-col gap-5 justify-start items-center flex-1 px-10", children: (0, jsx_runtime_1.jsx)(Link_1.default, {}) }), (0, jsx_runtime_1.jsx)("div", { className: "flex flex-row gap-2 justify-center py-5", children: (0, jsx_runtime_1.jsx)(Button_1.default, {}) })] })] })] }));
};
