...
const Setting = ({ data, css, resource }) => {
    ...
    return ((0, jsx_runtime_1.jsx)(AdminContext_1.AdminContext.Provider, { value: data, children: (0, jsx_runtime_1.jsx)(AdminContext_1.AdminCssContext.Provider, { value: css, children: (0, jsx_runtime_1.jsx)(AdminContext_1.AdminSettingContext.Provider, { value: [state, dispatch], children: (0, jsx_runtime_1.jsx)(AdminContext_1.AdminRegexContext.Provider, { value: resource.regexMap, children: (0, jsx_runtime_1.jsxs)(AdminContext_1.AdminLabelContext.Provider, { value: resource.labelMap, children: [(0, jsx_runtime_1.jsxs)("div", { className: 'flex flex-col', children: [(0, jsx_runtime_1.jsxs)("div", { id: "setting_board", className: 'flex gap-1', children: [state.background && ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(W_1.ColorPickerGradient, { keyValue: "W_colorPicker", defaultColor: css.background, cb: color => {
