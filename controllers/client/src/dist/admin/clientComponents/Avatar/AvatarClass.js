...
exports.AvatarClass = void 0;
const W_1 = require("../../../client/src/Web-Development/W");
const WW_1 = require("../../../client/src/Web-Development/WW");
const AvatarButtonClass_1 = __importDefault(require("./AvatarButtonClass"));
const EditAvatar_1 = __importDefault(require("./EditAvatar"));
class AvatarClass {
    constructor(options) {
        this.avatarButton = new AvatarButtonClass_1.default("#avatar__container");
