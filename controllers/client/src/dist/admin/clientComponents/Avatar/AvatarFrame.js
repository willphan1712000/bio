...
const AvatarFrame = () => {
    ...
    if (state.isUpload)
        return ((0, jsx_runtime_1.jsxs)("div", { className: `flex h-screen w-screen fixed top-0 left-0 backdrop-blur-[20px] z-[99] flex-col justify-center items-center px-[30px]`, children: [(0, jsx_runtime_1.jsx)("p", { className: "text-[20px] mb-[20px]", children: "Drag, Zoom, or Rotate Image" }), (0, jsx_runtime_1.jsx)("div", { className: "frame relative w-[100%] max-w-[800px] max-h-[800px] aspect-square border-dashed border-black border-4 rounded-[50%] p-[50px] overflow-hidden bg-white", ref: frameRef, children: (0, jsx_runtime_1.jsx)("div", { className: "wrapper", ref: wrapperRef, children: (0, jsx_runtime_1.jsx)("img", { className: "img__preview", src: state.previewSrc, ref: imageRef }) }) }), (0, jsx_runtime_1.jsxs)("div", { className: "btn flex flex-row gap-6 mt-[20px]", children: [(0, jsx_runtime_1.jsx)("div", { onClick: () => handleAccept(), className: "flex items-center accept rounded-[10px] bg-[#f0f0f0f0] p-[10px] shadow-lg cursor-pointer", children: "Accept" }), (0, jsx_runtime_1.jsx)("div", { onClick: () => handleCancel(), className: "cancel rounded-[10px] bg-[#f0f0f0f0] p-[10px] shadow-lg cursor-pointer", children: "Cancel" })] })] }));
};
