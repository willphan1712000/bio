...
const Dashboard = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "p-10", children: [(0, jsx_runtime_1.jsx)("h1", { className: headingClasses, children: "Welcome to Link bio Dashboard" }), (0, jsx_runtime_1.jsx)(StatCards_1.default, {}), (0, jsx_runtime_1.jsx)(AppLineChart_1.default, {})] }));
};
