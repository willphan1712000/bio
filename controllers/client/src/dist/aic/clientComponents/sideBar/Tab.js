...
const Tab = ({ to, name, icon, onClick }) => {
    ...
    if (to)
        return ((0, jsx_runtime_1.jsxs)(react_router_1.Link, { to: to, className: className, onClick: onClick, activeProps: {
            ...
            }, children: [icon, !isCollapse && (0, jsx_runtime_1.jsx)("p", { children: name })] }));
    return ((0, jsx_runtime_1.jsxs)("div", { className: className, onClick: onClick, children: [icon, !isCollapse && (0, jsx_runtime_1.jsx)("p", { children: name })] }));
};
exports.default = Tab;
