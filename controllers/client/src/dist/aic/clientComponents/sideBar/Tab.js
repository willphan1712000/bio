...
const Tab = ({ selected = false, name, icon, onClick }) => {
    ...
    return ((0, jsx_runtime_1.jsxs)("a", { className: className, onClick: onClick, children: [icon, !isCollapse && (0, jsx_runtime_1.jsx)("p", { children: name })] }));
};
exports.default = Tab;
