...
<body>
    ...
    <div class="signupParent">
        <div class="signupChild <?=$inactive;?>">
            ...
            <form action="" id="signup" method="POST">
                ...
                <button type="submit" name="submit" class="signupChild__confirm--php">Send</button>
            </form>
            <p class="signupChild__msg">Forgot username? <a href="/forgotUsername">Click here</a>
        </div>
    ...
    <script>const type = 'forgot'</script>
