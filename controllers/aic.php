...
<body>
    <div class="warning__parent">
        <div class="warning__child">
            ...
            <p>Warning, all information of this account will be deleted, are you sure you want to proceed?</p>
            <div class="btn">
    ...
    <div id="container">
        <div class="logo">
            ...
            <form action="" method="POST">
                <button name='aicLogout' class='aicLogout'>Sign out <i class="fa-solid fa-right-from-bracket"></i></button>
            </form>
        </div>
        <div id="userData"></div>
        <div id="copyright">
