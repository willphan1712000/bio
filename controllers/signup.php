...
<body>
    ...
    <div class="signupParent">
        <div class="passRequirements">
            <p><i class="fa-solid fa-arrow-down" style="margin-right: 2px"></i> PASSWORD REQUIREMENTS</p>
            <br></br>
            <p>Password must have at least 12 characters</p>
            <br></br>
            <p>Password must have at least 1 upper case</p>
            <br></br>
        ...
        <div class="signupChild">
            <h1>Sign Up</h1>
            <span class="signupChild__error">Please fill in all information!</span>
            ...
            <p class="signupChild__msg">Already have an account? <a href="/signin">Sign in</a></p>
        </div>
        <div class="signupChild signupSuccess">
            <div class="signupSuccess__logo">
                <i class="fa-solid fa-check"></i>
            </div>
            <div class="signupSuccess__text">
                <h1>You have signed up successfully</h1>
            </div>
            <div class="signupSuccess__btn">
                <a href="/signin">Sign in</a>
                <a href="/signup">Create another</a>
            </div>
        </div>
    </div>
    <div id="copyright">
